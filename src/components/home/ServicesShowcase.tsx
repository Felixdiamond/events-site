...
const services = [
  {
    ...
    description: 'Crafting timeless love stories with exquisite details and seamless coordination. From intimate ceremonies to grand celebrations.',
    ...
    stats: '100+ Dream Weddings',
  },
  {
    id: 'corporate',
    title: 'Corporate Events',
    description: 'Elevating your brand with sophisticated corporate events that leave lasting impressions and achieve business objectives.',
    ...
    stats: '200+ Corporate Events',
  },
  {
    id: 'social',
    title: 'Social Celebrations',
    description: 'Transforming special moments into extraordinary memories with creative themes and personalized experiences.',
    ...
    stats: '300+ Happy Clients',
  },
  {
    id: 'luxury',
    title: 'Luxury Experiences',
    description: 'Curating exclusive, high-end events with unparalleled attention to detail and white-glove service.',
    ...
    <section ref={sectionRef} className="relative py-24 md:py-32 overflow-hidden">
      ...
      <div className="absolute inset-0 bg-gradient-to-b from-secondary/95 via-secondary to-secondary/95">
        <motion.div
          ...
          animate={{
            background: [
              "radial-gradient(800px circle at 100% 0%, rgba(212, 175, 55, 0.04), transparent 70%)",
              "radial-gradient(600px circle at 0% 100%, rgba(212, 175, 55, 0.04), transparent 70%)",
              "radial-gradient(800px circle at 100% 0%, rgba(212, 175, 55, 0.04), transparent 70%)",
            ],
          }}
          transition={{ 
