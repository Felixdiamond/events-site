...
export const metadata: Metadata = {
  ...
  authors: [{ name: "Sparkling World Business & Events" }],
  creator: "Sparkling World Business & Events",
  publisher: "Sparkling World Business & Events",
  robots: {
    index: true,
    follow: true,
    googleBot: {
  ...
  openGraph: {
    ...
    title: "Sparkling World Business & Events | Just dream it, we’ll deliver!",
    ...
    siteName: "Sparkling World Business & Events",
    images: [
      {
        url: "https://sparklingworldevents.com/images/og-image.jpg",
        width: 1200,
        height: 630,
        alt: "Sparkling World Business & Events - Premier Event Planning Services",
      },
    ],
  },
  twitter: {
    card: "summary_large_image",
    title: "Sparkling World Business & Events | Premier Event Planning",
